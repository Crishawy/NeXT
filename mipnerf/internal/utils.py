...
class Config:
    ...
    test_skip: int = 8  # test skip for deepvoxel dataset
    ...
    # batch_size: int = 10  # The number of rays/pixels in each batch.
    ...
    shape: str = 'vase'     # scene of deepvoxel
